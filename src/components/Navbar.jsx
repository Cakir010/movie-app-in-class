...
const Navbar = () => {
  ...
  // const currentUser = { displayName: "Emre Çakır" };

  return (
    <div>
      <nav
        className=" flex w-full flex-wrap items-center justify-between bg-neutral-100! bg-gray-900 py-3 text-neutral-200 shadow-lg lg:flex-wrap lg:justify-start fixed-top-0 z-20"
        data-te-navbar-ref=""
      >
